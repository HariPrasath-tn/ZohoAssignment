...
//        this.makeStack2();
    ...
    public void enqueue(int number) throws Exception{
        if(this.isFull()){
            throw new QueueException("openChallenges.Queue Overflows Exception");
        }
    ...
    public void dequeue() throws Exception{
        if(this.isEmpty()){
            throw new QueueException("openChallenges.Queue underflow Exception");
        }
        this.popStack1();
    }
    ...
    public void printQueue() throws Exception{
        ...
        out.print("openChallenges.Queue elements are : ");
