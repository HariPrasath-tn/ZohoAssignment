package kotlin_assignment._41To50;
...
final class P43_LeftRotateArray {
    ...
    public static void main(String [] args){
        P43_LeftRotateArray program43 = new P43_LeftRotateArray();

        try{
            out.println("\nTool to rotate the array into given number of steps");
            int[] array = program43.getArrayFromUser(); // getting array from the user
            out.print("Enter the number of steps to rotate : ");
            int steps = getIntegerFromUser(); // steps to rotate
            array = program43.rotateThisArray(array, steps); // rotating the given array of given number of steps
            program43.printThisArray(array);  // printing the given array
        }catch (Exception e){
